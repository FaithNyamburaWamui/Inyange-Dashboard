...
//   const filteredMaterials = materials.filter((material: { material_name: string; }) =>
...
//               className="border rounded-l pl-10 pr-4 py-2"
//               value={searchTerm}
...
//           </div>
//           <button
//             className="bg-[#F8B612] text-white px-4 py-2 rounded-r flex items-center"
...
//           &lt;
//         </button>
//         {[...Array(Math.ceil(filteredMaterials.length / itemsPerPage))].map((_, index) => (
//           <button
//             key={index}
